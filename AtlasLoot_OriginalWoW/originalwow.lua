...
---- Azuregos
	...
	AtlasLoot_Data["BlackfathomDeeps1"] = {
		...
		{ 2, 6908, "", "=q2=Ghamoo-ra's Bind", "=ds=#s10#, #a1#", "", "45.81%"};
		...
		{ 7, 11121, "", "=q2=Darkwater Talwar", "=ds=#h3#, #w10#", "", "33.10%"};
		{ 8, 3078, "", "=q2=Naga Heartpiercer", "=ds=#w2#", "", "16.87%"};
		{ 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Gelihast"], ""};
		{ 11, 6906, "", "=q3=Algae Fists", "=ds=#s9#, #a3#", "", "38.24%"};
		{ 12, 6905, "", "=q2=Reef Axe", "=ds=#h2#, #w1#", "", "42.29%"};
		{ 13, 1470, "", "=q2=Murloc Skin Bag", "=ds=#m12# #e1#", "", "14.13%"};
		...
		{ 22, 6903, "", "=q2=Gaze Dreamer Pants", "=ds=#s11#, #a1#", "", "31.90%"};
		...
		{ 28, 6902, "", "=q2=Bands of Serra'kis", "=ds=#s8#, #a2#", "", "29.24%"};
	...
	AtlasLoot_Data["BlackfathomDeeps2"] = {
		...
		{ 25, 3414, "", "=q3=Crested Scepter", "=ds=#h3#, #w6#", "", "0.01%"};
	...
	AtlasLoot_Data["BRDLordRoccor"] = {
		...
		{ 5, 60245, "", "=q3=Moss-hewn Mace", "=ds=#h3#, #w6#", "", ""};
		{ 6, 60227, "", "=q3=Earth Lord´s Chain Cap", "=ds=#s1#, #a3#", "", ""};

		{ 8, 11630, "", "=q3=Rockshard Pellets", "=ds=#w18#", "", "16.82%"};
	...
	AtlasLoot_Data["BRDHighInterrogatorGerstahn"] = {
		...
		{ 5, 60224, "", "=q3=Circlet of Ill Intent", "=ds=#s1#, #a3#", "", ""};
		{ 6, 60234, "", "=q3=Gauntlets of Mercy", "=ds=#s9#, #a4#", "", ""};
		{ 8, 11140, "", "=q1=Prison Cell Key", "=ds=#e9#"};
		Next = "BRDArena";
		Prev = "BRDLordRoccor";
	};
	...
	AtlasLoot_Data["BRDArena"] = {
		...
		{ 7, 11685, "", "=q3=Splinthide Shoulders", "=ds=#s3#, #a2# =q2=#brd2#", "", "24.49%"};
		{ 8, 11686, "", "=q3=Girdle of Beastial Fury", "=ds=#s10#, #a2# =q2=#brd2#", "", "15.85%"};
		{ 9, 11679, "", "=q3=Rubicund Armguards", "=ds=#s8#, #a3# =q2=#brd2#", "", "25.13%"};
		{ 10, 11730, "", "=q3=Savage Gladiator Grips", "=ds=#s9#, #a3# =q2=#brd2#", "", "14.12%"};
	...
	AtlasLoot_Data["BRDArena2"] = {
		...
		{ 7, 11662, "", "=q3=Ban'thok Sash", "=ds=#s10#, #a1# =q2=#brd6#", "", "23.77%"};
		{ 8, 11665, "", "=q3=Ogreseer Fists", "=ds=#s9#, #a2# =q2=#brd6#", "", "28.16%"};
		{ 9, 11728, "", "=q3=Savage Gladiator Leggings", "=ds=#s11#, #a3# =q2=#brd6#", "", "14.95%"};
		{ 10, 11824, "", "=q3=Cyclopean Band", "=ds=#s13# =q2=#brd6#", "", "18.37%"};
		{ 16, 60262, "", "=q3=Used Abomination Stitching", "=ds=#s10#, #a2# =q2="..BabbleEpoch["Twitches"], ""};
		{ 18, 20003, "", "=q3=Devilsaur´s Right Claws", "=ds=#h3#, #w13# =q2="..BabbleEpoch["Zuul"], ""};
		{ 19, 60235, "", "=q3=Gavel of Gozer", "=ds=#h1#, #w6# =q2="..BabbleEpoch["Zuul"], ""};
		{ 22, 60228, "", "=q3=Refillable Egg", "=ds=#s14# =q2="..BabbleEpoch["Mecha-Chicken 3000"], ""};
		{ 23, 60243, "", "=q3=Mecha X-850 ´´Squawker´´ Rifle", "=ds=#w5# =q2="..BabbleEpoch["Mecha-Chicken 3000"], ""};
		Next = "BRDTheldren";
		Prev = "BRDArena";
	};
	...
	AtlasLoot_Data["BRDHoundmaster"] = {
		...
		{ 6, 60266, "", "=q3=Wolf-fang Slicer", "=ds=#h2#, #w10#", "", ""};
		{ 7, 60218, "", "=q3=Bouquet of Dogwood Blossoms", "=ds=#s15#", "", ""};
	...
	AtlasLoot_Data["BRDTheVault"] = {
		...
		{ 13, 60284, "", "=q3=Plans: Pristine Black Diamond Amulet", "=ds=#p2# (290)", "", ""};
		{ 16, 0, "INV_Box_01", "=q6=#x4#", ""};
		{ 17, 64912, "", "=q3=Depths Warding Torch", "=ds=#s15#", "", ""};
		{ 19, 11752, "", "=q1=Black Blood of the Tormented", "=ds=#m3#", "", "44.48%"};
		{ 20, 11751, "", "=q1=Burning Essence", "=ds=#m3#", "", "39.35%"};
		{ 21, 11753, "", "=q1=Eye of Kajal", "=ds=#m3#", "", "39.95%"};
	...
	AtlasLoot_Data["BRDWarderStilgiss"] = {
		...
		{ 5, 60222, "", "=q3=Chillorb Icestaff", "=ds=#w9#", "", ""};
		{ 6, 60264, "", "=q3=Warden's Frost Ward", "=ds=#s2#", "", ""};
		Next = "BRDVerek";
		Prev = "BRDTheVault";
	};
	...
	AtlasLoot_Data["BRDDoomgrip"] = {
		{ 1, 60226, "", "=q2=Doomgrip´s Truncheon", "=ds=#h2#, #w6#", "", ""};
		{ 2, 60214, "", "=q2=Arcane Locksmith´s Drape", "=ds=#s4#", "", ""};
		{ 3, 60258, "", "=q2=Thief Catcher's Signet", "=ds=#s13#", "", ""};
	...
	AtlasLoot_Data["BRDFineousDarkvire"] = {
		...
		{ 5, 60255, "", "=q3=Staff of Sacred Stars", "=ds=#w9#", "", ""};
		{ 6, 60252, "", "=q3=Shoulderpads of Civic Planning", "", "", ""};
		{ 8, 11840, "", "=q1=Master Builder's Shirt", "#s6#", "", "3.9%"};
		{ 10, 10999, "", "=q1=Ironfel", "=ds=#m3#", "", "100%"};
		Next = "BRDLordIncendius";
		Prev = "BRDDoomgrip";
	};

	AtlasLoot_Data["BRDLordIncendius"] = {
		{ 1, 60238, "", "=q3=Incendius´s Heart", "=ds=#s14#", "", ""};
		{ 2, 60261, "", "=q3=Unmelting Chain", "=ds=#s2# =q2=#m16#", "", ""};
		{ 3, 11768, "", "=q2=Incendic Bracers", "=ds=#s8#, #a1#", "", "1.30%"};
		{ 5, 11766, "", "=q3=Flameweave Cuffs", "=ds=#s8#, #a1# =q2=#m16#", "", "18.88%"};
		{ 6, 11764, "", "=q3=Cinderhide Armsplints", "=ds=#s8#, #a2# =q2=#m16#", "", "18.33%"};
		{ 7, 11765, "", "=q3=Pyremail Wristguards", "=ds=#s8#, #a3# =q2=#m16#", "", "18.85%"};
		{ 8, 11767, "", "=q3=Emberplate Armguards", "=ds=#s8#, #a4# =q2=#m16#", "", "19.24%"};
		{ 10, 19268, "", "=q3=Ace of Elementals", "=ds=#e16#", "", "2.10%"};
		{ 16, 21987, "", "=q1=Incendicite of Incendius", "=ds=#m3#"};
		{ 17, 11126, "", "=q1=Tablet of Kurniya", "=ds=#m3#"};
		Next = "BRDBaelGar";
	...
	AtlasLoot_Data["BRDBaelGar"] = {
		...
		{ 5, 60219, "", "=q3=Chain of Charged Stones", "=ds=#s2#", "", ""};
		{ 6, 60221, "", "=q3=Chestplate of Cleansing Earth", "=ds=#s5# #a4#", "", ""};
	...
	AtlasLoot_Data["BRDGeneralAngerforge"] = {
		...
		{ 4, 11817, "", "=q3=Lord General's Sword", "=ds=#h3#, #w10# ", "", "14.72%"};
		{ 5, 11816, "", "=q3=Angerforge's Battle Axe", "=ds=#h2#, #w1#", "", "16.41%"};
		{ 6, 60230, "", "=q3=Epaulets of the Dwarven Champion", "=ds=#s3#, #a4#", "", ""};
		{ 7, 60244, "", "=q3=Medic´s Suturing Blade", "=ds=#h3#, #w10#", "", ""};
		{ 9, 11464, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#"};
	...
	AtlasLoot_Data["BRDGolemLordArgelmach"] = {
		...
		{ 5, 60241, "", "=q3=Lightning Conductor", "=ds=#h2#, #w6#", "", ""};
		{ 7, 11268, "", "=q1=Head of Argelmach", "=ds=#m3#"};
		{ 8, 11465, "", "=q1=Marshal Windsor's Lost Information", "=ds=#m3#"};
		Next = "BRDGuzzler";
	...
	AtlasLoot_Data["BRDGuzzler"] = {
		...
		{ 6, 60263, "", "=q3=Wand of Zealotry", "=ds=#w12#", "", ""};
		{ 7, 60259, "", "=q3=Torch of Eternal Justice", "=ds=#s15#", "", ""};
		{ 9, 11312, "", "=q1=Lost Thunderbrew Recipe", "=ds=#m3#"};
		{ 16, 0, "INV_Box_01", "=q6=#n49#", ""};
		{ 17, 60246, "", "=q3=Phalanx´s Core-Plate", "=ds=#w8#", "", ""};
		...
		{ 21, 60215, "", "=q3=Auto-Repairing Restraints", "=ds=#s8#, #a4#", "", ""};
		Next = "BRDGuzzler2";
		Prev = "BRDGolemLordArgelmach";
	};

	AtlasLoot_Data["BRDGuzzler2"] = {
		{ 1, 0, "INV_Box_01", "=q6=#n50#", ""};
		{ 2, 11612, "", "=q3=Plans: Dark Iron Plate", "=ds=#p2# (285)", "", "22.20%"};
		{ 4, 60248, "", "=q3=Ribbly's Boomstick", "=ds=#w5#", "", ""};
		{ 5, 60257, "", "=q3=Tears of the Charlatan Saint", "=ds=#s14#", "", ""};
		{ 6, 60247, "", "=q2=Ribbly's Blackened Armor", "=ds=#s5#, #a3#", "", ""};
		{ 7, 60225, "", "=q3=Decorative Vial of Antivenom", "", "", ""};
		{ 9, 2662, "", "=q2=Ribbly's Quiver", "=ds=#m13# #w19#", "", "17.03%"};
		{ 10, 2663, "", "=q2=Ribbly's Bandolier", "=ds=#m13# #w20#", "", "15.73%"};
		{ 11, 11742, "", "=q2=Wayfarer's Knapsack", "=ds=#m13# #e1#", "", "25.07%"};
		{ 13, 11313, "", "=q1=Ribbly's Head", "=ds=#m3#"};
		{ 16, 0, "INV_Box_01", "=q6=#n51#", ""};
		{ 17, 60256, "", "=q4=Stave of All-Purpose Magic", "=ds=#w9#", "", ""};
		{ 19, 60216, "", "=q3=Bartender´s Bracers", "=ds=#s8#, #a3#", "", ""};
		{ 20, 12793, "", "=q3=Mixologist's Tunic", "=ds=#s5#, #a2#", "", "24.87%"};
		{ 21, 12791, "", "=q3=Barman Shanker", "=ds=#h3#, #w4#", "", "6.97%"};
		...
		{ 27, 11602, "", "=q1=Grim Guzzler Key", "=ds=#e9#"};
		{ 28, 11325, "", "=q1=Dark Iron Ale Mug", "=ds=#m3#"};
		Next = "BRDFlamelash";
		Prev = "BRDGuzzler";
	};
	...
	AtlasLoot_Data["BRDFlamelash"] = {
		...
		{ 7, 60254, "", "=q3=Staff of Fiery Diplomacy", "=ds=#w9#", "", ""};
		{ 8, 60217, "", "=q3=Boots of Natural Fire", "", "", ""};
		{ 10, 23320, "", "=q3=Tablet of Flame Shock VI", "=ds=#e10# =q1=#m1# =ds=#c7#"};
		Next = "BRDPanzor";
		Prev = "BRDGuzzler2";
	};
	...
	AtlasLoot_Data["BRDTomb"] = {
		...
		{ 2, 60251, "", "=q4=Shield of Sevens", "=ds=#w8#", "", ""};
		{ 4, 11929, "", "=q3=Haunting Specter Leggings", "=ds=#s11#, #a1#", "", "22.60%"};
		{ 5, 11925, "", "=q3=Ghostshroud", "=ds=#s1#, #a2#", "", "21.63%"};
		{ 6, 11926, "", "=q3=Deathdealer Breastplate", "=ds=#s5#, #a3#", "", "22.08%"};
		{ 7, 11927, "", "=q3=Legplates of the Eternal Guardian", "=ds=#s11#, #a4#", "", "65.45%"};
		{ 8, 11922, "", "=q3=Blood-etched Blade", "=ds=#h1#, #w4#", "", "22.05%"};
		{ 9, 11920, "", "=q3=Wraith Scythe", "=ds=#h1# #w1#", "", "22.61%"};
		{ 10, 11923, "", "=q3=The Hammer of Grace", "=ds=#h3#, #w6#", "", "21.29%"};
		{ 11, 11921, "", "=q3=Impervious Giant", "=ds=#h2#, #w6#", "", "22.23%"};
		{ 12, 60231, "", "=q3=Exorcist´s Hammer", "=ds=#h3#, #w6#", "", ""};
		{ 13, 60249, "", "=q3=Sacred Spectral Raiment", "=ds=#s5#, #a2#", "", ""};
		Next = "BRDMagmus";
		Prev = "BRDPanzor";
	};
	...
	AtlasLoot_Data["BRDMagmus"] = {
		...
		{ 6, 60242, "", "=q3=Magma-Heated Iron Rod", "=ds=#s15#", "", ""};
		{ 7, 60236, "", "=q3=Giant-Forged Shoulderguards", "=ds=#s3#, #a3#", "", ""};
	...
	AtlasLoot_Data["BRDImperatorDagranThaurissan"] = {
		...
		{ 10, 60239, "", "=q3=Iron Cloak of Magic", "=ds=#s4#", "", ""};
		{ 11, 60237, "", "=q3=Greaves of the Deep Light", "=ds=#s11#, #a4#", "", ""};
		{ 12, 60220, "", "=q3=Charm of Righteous Anger", "=ds=#s2#", "", ""};
	...
	AtlasLoot_Data["LBRSOmokk"] = {
		{ 1, 60412, "", "=q3=Highlord´s Epaulet of Hittin´ Gud", "=ds=#s3#, #a4#", "", ""};
	...
	AtlasLoot_Data["LBRSVosh"] = {
		...
		{ 7, 60417, "", "=q3=Shadow Hunter´s Salve", "=ds=#s15#", "", ""};
		{ 8, 60419, "", "=q3=Wand of Forest Magic", "=ds=#w12#", "", ""};
		{ 10, 13352, "", "=q1=Vosh'gajin's Snakestone", "=ds=#m3#", "", "100%"};
		{ 11, 12821, "", "=q3=Plans: Dawn's Edge", "=q1=#m4#: =ds=#p2# (275)"};
	...
	AtlasLoot_Data["LBRSVoone"] = {
		{ 1, 60421, "", "=q3=Warmaster´s Cuirass", "=ds=#s5#, #a4#", "", ""};
		...
		{ 6, 13173, "", "=q3=Flightblade Throwing Axe", "=ds=#w11#", "", "79.85%"};
		{ 7, 60419, "", "=q3=Wand of Forest Magic", "=ds=#w12#", "", ""};
	...
	AtlasLoot_Data["LBRSSmolderweb"] = {
		...
		{ 4, 60404, "", "=q3=Bulging Egg Sac", "=ds=#s14#", "", ""};
	...
	AtlasLoot_Data["LBRSSlavener"] = {
		...
		{ 4, 60407, "", "=q3=Drool-Stained Shroud", "=ds=#s4#", "", ""};
	...
	AtlasLoot_Data["LBRSBashguud"] = {
		...
		{ 4, 60415, "", "=q3=Ring of Furious Redoubt", "=ds=#s13#", "", ""};
		Next = "LBRSWyrmthalak";
		Prev = "LBRSHalycon";
	};
	...
	AtlasLoot_Data["LBRSWyrmthalak"] = {
		...
		{ 2, 60410, "", "=q4=Fury of the Black Brood", "=ds=#w12#", "", ""};

		{ 4, 13162, "", "=q3=Reiver Claws", "=ds=#s9#, #a4#", "", "12.14%"};
		{ 5, 13164, "", "=q3=Heart of the Scale", "=ds=#s14#", "", "0.73%"};
		{ 6, 22321, "", "=q3=Heart of Wyrmthalak", "=ds=#s14#", "", "13.87%"};
		{ 7, 13163, "", "=q3=Relentless Scythe", "=ds=#h2#, #w10#", "", "14.12%"};
		{ 8, 13148, "", "=q3=Chillpike", "=ds=#w7#", "", "0.76%"};
		{ 9, 13161, "", "=q3=Trindlehaven Staff", "=ds=#w9#", "", "10.40%"};
		{ 10, 60414, "", "=q3=Mark of the Overlord", "=ds=#s13#", "", ""};
		{ 11, 60413, "", "=q3=Mallet of the Black Flight", "=ds=#h2#, #w6#", "", ""};
		{ 12, 60405, "", "=q3=Darkmage´s Dragonstaff", "=ds=#w9#", "", ""};
		{ 13, 60408, "", "=q3=Electrified Dragon Scale", "=ds=#s14#", "", ""};


		{ 16, 16679, "", "=q3=Beaststalker's Mantle", "=ds=#s3#, #a3# (D1, #c2#)", "", "9.89%"};

		{ 18, 12337, "", "=q2=Gemstone of Bloodaxe", "=ds=#m3#", "", "100%"};
		Next = "LBRSFelguard";
		Prev = "LBRSBashguud";
	};
	...
	AtlasLoot_Data["UBRSEmberseer"] = {
		...
		{ 5, 60691, "", "=q3=Shard of The Pyroguard", "=ds=#h3#, #w4#", "", ""};
		{ 7, 17322, "", "=q1=Eye of the Emberseer", "=ds=#m3#", "", "100%"};
		{ 8, 21988, "", "=q1=Ember of Emberseer", "=ds=#m3#"};
	...
	AtlasLoot_Data["UBRSRend"] = {
		...
		{ 5, 12590, "", "=q4=Felstriker", "=ds=#h1#, #w4#", "", "1.06%"};
		{ 6, 60681, "", "=q3=Amulet of Chromatic Warding", "=ds=#s2#", "", ""};
		{ 7, 22247, "", "=q3=Faith Healer's Boots", "=ds=#s12#, #a1#", "", "12.71%"};
		{ 8, 18102, "", "=q3=Dragonrider Boots", "=ds=#s12#, #a1#", "", "14.35%"};
		{ 9, 12587, "", "=q3=Eye of Rend", "=ds=#s1#, #a2#", "", "14.50%"};
		{ 10, 12588, "", "=q3=Bonespike Shoulder", "=ds=#s3#, #a3#", "", "0.85%"};
		{ 11, 18104, "", "=q3=Feralsurge Girdle", "=ds=#s10#, #a3#", "", "15.30%"};
		{ 12, 12936, "", "=q3=Battleborn Armbraces", "=ds=#s8#, #a4#", "", "16.96%"};
		{ 13, 12935, "", "=q3=Warmaster Legguards", "=ds=#s11#, #a4#", "", "15.05%"};
		{ 14, 18103, "", "=q3=Band of Rumination", "=ds=#s13#", "", "15.38%"};
		{ 15, 60685, "", "=q3=Brute's Edge", "=ds=#h2#, #w1#", "", ""};
		{ 16, 16733, "", "=q3=Spaulders of Valor", "=ds=#s3#, #a4# (D1, #c9#)", "", "13.39%"};
		{ 17, 16669, "", "=q3=Pauldrons of Elements", "=ds=#s3#, #a3# (D1, #c7#)", "", "14.77%"};
		{ 19, 12940, "", "=q3=Dal'Rend's Sacred Charge", "=ds=#h3#, #w10#", "", "6.79%"};
		{ 20, 12939, "", "=q3=Dal'Rend's Tribal Guardian", "=ds=#h4#, #w10#", "", "7.61%"};
		{ 21, 12583, "", "=q3=Blackhand Doomsaw", "=ds=#w7#", "", "7.44%"};
		{ 22, 60682, "", "=q3=Battle Healer´s Barrier", "=ds=#w8#", "", ""};
		{ 23, 22225, "", "=q3=Dragonskin Cowl", "=ds=#s1#, #a1# =q2=#m16#", "", "11.85%"};
		{ 24, 12960, "", "=q3=Tribal War Feathers", "=ds=#s1#, #a2# =q2=#m16#", "", "15.24%"};
		{ 25, 12953, "", "=q3=Dragoneye Coif", "=ds=#s1#, #a3# =q2=#m16#", "", "15.99%"};
		{ 26, 12952, "", "=q3=Gyth's Skull", "=ds=#s1#, #a4# =q2=#m16#", "", "12.43%"};
		{ 27, 60684, "", "=q3=Blackhand´s Bracers", "=q2=#m16#", "", ""};
		{ 28, 13522, "", "=q2=Recipe: Flask of Chromatic Resistance", "=ds=#p1# (300)", "", "2.95%"};
		{ 29, 64920, "", "=q4=Pattern: Chromatic Helm", "=ds=#p9# (300)", "", ""};
		{ 30, 12630, "", "=q1=Head of Rend Blackhand", "=ds=#m3#", "", "100%"};
		Next = "UBRSBeast";
		Prev = "UBRSAnvilcrack";
	};
	...
	AtlasLoot_Data["UBRSBeast"] = {
		...
		{ 13, 12709, "", "=q3=Finkle's Skinner", "=ds=#h3#, #w4#, =q1=#e18#", "", "6.95%"};
	...
	AtlasLoot_Data["UBRSDrakkisath"] = {
		...
		{ 2, 22269, "", "=q3=Shadow Prowler's Cloak", "=ds=#s4#", "", "10.61%"};
		{ 3, 22267, "", "=q3=Spellweaver's Turban", "=ds=#s1#, #a1#", "", "15.50%"};
		{ 4, 13142, "", "=q3=Brigam Girdle", "=ds=#s10#, #a4#", "", "16.40%"};
		{ 5, 13141, "", "=q3=Tooth of Gnarr", "=ds=#s2#", "", "16.83%"};
		{ 6, 13098, "", "=q3=Painweaver Band", "=ds=#s13#", "", "13.51%"};
		{ 7, 22268, "", "=q3=Draconic Infused Emblem", "=ds=#s14#", "", "4.13%"};
		{ 8, 22253, "", "=q3=Tome of the Lost", "=ds=#s15#", "", "16.05%"};
		{ 9, 12602, "", "=q3=Draconian Deflector", "=ds=#w8#", "", "14.52%"};
		{ 10, 60686, "", "=q3=Crystal Lattice", "=ds=#s2#", "", ""};
		{ 11, 60689, "", "=q3=General's Medallion", "=ds=#s2#", "", ""};
		{ 12, 60690, "", "=q3=Helm of Draconik Leadership", "=ds=#s1#, #a4#", "", ""};
		{ 14, 15730, "", "=q3=Pattern: Red Dragonscale Breastplate", "=ds=#p7# (300)", "", "3.58%"};
		{ 15, 15047, "", "=q3=Red Dragonscale Breastplate", "=ds=#s5#, #a3#"};
		...
		{ 28, 13519, "", "=q2=Recipe: Flask of the Titans", "=ds=#p1# (300)", "", "1.72%"};
	...
	AtlasLoot_Data["Glittermurk"] = {
		...
		{ 2, 60389, "", "=q3=Staff of Motivation", "=ds=#w9#", "", ""};
		{ 3, 60380, "", "=q3=Gnoll Cuffs", "=ds=#s8#, #a2#", "", ""};
		{ 4, 60391, "", "=q2=Tarnished Linked Leggings", "=ds=#s11#, #a3#", "", ""};
		{ 5, 60383, "", "=q2=Pure Gold Band", "=ds=#s13#", "", ""};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleEpoch["Miner Davod"], ""};
		{ 8, 61916, "", "=q3=Davod´s Lantern", "=ds=#s15#", "", ""};
		{ 10, 0, "INV_Box_01", "=q6="..BabbleEpoch["Foreman Sprocket"], ""};
		{ 11, 60381, "", "=q3=Heavy Metal Belt", "=ds=#s10#, #a4#", "", ""};
		{ 12, 60392, "", "=q3=Throwing ´Saws´", "=ds=#w11#", "", ""};
		{ 13, 60386, "", "=q3=Shredder Spaulders", "=ds=#s3#, #a3#", "", ""};
		{ 14, 60390, "", "=q3=Steel Pickaxe", "=ds=#h1#, #w1#", "", ""};
		{ 15, 99999, "", "=q1=Foreman's Head", "=ds=#m3# =q2=Booty Bay", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Krakken"], ""};
		{ 17, 60378, "", "=q3=Faded Ring of Truestrike", "=ds=#s13#", "", ""};
		{ 18, 60384, "", "=q3=Sash of Aquatic Gliding", "=ds=#s10#, #a2#", "", ""};
		{ 19, 60376, "", "=q3=Deepsea Coral", "=ds=#s14#", "", ""};
		{ 20, 60366, "", "=q3=Aquablade", "=ds=#h1#, #w10#", "", ""};
		{ 22, 0, "INV_Box_01", "=q6="..BabbleEpoch["Prismscale"], ""};
		{ 23, 60369, "", "=q3=Chromatic Wand", "=ds=#w12#", "", ""};
		{ 24, 60394, "", "=q3=Unknown Stone Tooth", "=ds=#h1#, #w4#", "", ""};
		{ 25, 60397, "", "=q3=Warding Scale", "=ds=#s14#", "", ""};
		{ 26, 60396, "", "=q2=Venturing Bracelets", "=ds=#s8#, #a1#", "", ""};
		{ 27, 99999, "", "=q1=Prismatic Scales", "=ds=#m3# =q2=Booty Bay", "", ""};
		Next = "Glittermurk2";
	};

	AtlasLoot_Data["Glittermurk2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Murklurk"], ""};
		{ 2, 60385, "", "=q3=Shadowcasters Hood", "=ds=#s1#, #a1#", "", ""};
		{ 3, 60379, "", "=q3=Forgotten Shoulderpads", "=ds=#s3#, #a2#", "", ""};
		{ 4, 60365, "", "=q3=Amulet of Brawn", "=ds=#s2#", "", ""};
		{ 5, 60387, "", "=q3=Shoud of the Mur'gul", "=ds=#s4#", "", ""};
		{ 6, 99999, "", "=q1=Deeg's Lost Pipe", "=ds=#m3# =q2=Booty Bay", "", ""};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleEpoch["Gnash"], ""};
		{ 9, 60393, "", "=q4=Trident of Nazjatar", "=ds=#w7#", "", ""};
		{ 10, 60382, "", "=q3=Naga Precision", "=ds=#w2#", "", ""};
		{ 11, 60375, "", "=q3=Crown of Tides", "=ds=#s1#, #a3#", "", ""};
		{ 12, 60377, "", "=q3=Encrusted Fetish", "=ds=#s15#", "", ""};
		{ 13, 60368, "", "=q3=Buckler of Seas", "=ds=#w8#", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Quest Item"], ""};
		{ 17, 99999, "", "=q1=Azothan Idol", "=ds=#m3# =q2=Front of dungeon", "", ""};
		{ 18, 61926, "", "=q1=Recovered Tools", "=ds=#m3# =q2=Gadgetzan", "", ""};
		Prev = "Glittermurk";
	};
	...
	AtlasLoot_Data["Gnomeregan1"] = {
		...
		{ 3, 60398, "", "=q3=Chompers Chomper", "=ds=#h3#, #w13#", "", ""};
		{ 4, 60399, "", "=q3=Slippery Sole Sandals", "=ds=#s12#, #a2#", "", ""};
		{ 5, 60400, "", "=q2=Strangely Strong Stone Spear", "=ds=#w7#", "", ""};
		{ 6, 60401, "", "=q2=Trogghide Pads", "=ds=#s3#, #a2#", "", ""};
		...
		{ 17, 9447, "", "=q3=Electrocutioner Lagnut", "=ds=#s13#", "", "28.44%"};
		{ 18, 9446, "", "=q3=Electrocutioner Leg", "=ds=#h3#, #w10#", "", "13.19%"};
		{ 19, 9448, "", "=q2=Spidertank Oilrag", "=ds=#s8#, #a1#", "", "28.37%"};
		...
		{ 24, 9450, "", "=q2=Gnomebot Operating Boots", "=ds=#s12#, #a2#", "", "60.45%"};
	...
	AtlasLoot_Data["Maraudon1"] = {
		...
		{ 5, 61951, "", "=q3=Vile Twisted Boots", "=ds=#s12#, #a4#", "", ""};
		{ 6, 17702, "", "=q1=Celebrian Rod", "=ds=#m3#", "", "100%"};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorlash"], ""};
		{ 9, 61956, "", "=q3=Razor Lined Breastplate", "=ds=#s5#", "", ""};
		{ 10, 17748, "", "=q3=Vinerot Sandals", "=ds=#s12#, #a1#", "", "20.60%"};
		{ 11, 17749, "", "=q3=Phytoskin Spaulders", "=ds=#s3#, #a2#", "", "22.09%"};
		{ 12, 17751, "", "=q2=Brusslehide Leggings", "=ds=#s11#, #a2#", "", "21.65%"};
		{ 13, 17750, "", "=q2=Chloromesh Girdle", "=ds=#s10#, #a1#", "", "22.93%"};
	...
	AtlasLoot_Data["Maraudon2"] = {
		...
		{ 12, 17943, "", "=q3=Fist of Stone", "=ds=#h3#, #w6#", "", "16.58%"};
	...
	AtlasLoot_Data["Maraudon3"] = {
		...
		{ 2, 17780, "", "=q4=Blade of Eternal Darkness", "=ds=#h3#, #w4#", "", "0.20%"};
		...
		{ 9, 17710, "", "=q3=Charstone Dirk", "=ds=#h3#, #w4#", "", "14.24%"};
	...
	AtlasLoot_Data["RagefireChasm"] = {
		...
		{ 4, 14145, "", "=q2=Cursed Felblade", "=ds=#h3#, #w10#", "", "15.98%"};
		{ 5, 60427, "", "=q2=Felguard Sash", "=ds=#s10#, #a2#", "", ""};
		{ 6, 14540, "", "=q1=Taragaman the Hungerer's Heart", "=ds=#m3#", "", "100%"};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Jergosh the Invoker"], ""};
		{ 9, 14150, "", "=q2=Robe of Evocation", "=ds=#s5#, #a1#", "", "36.40%"};
		{ 10, 14147, "", "=q2=Cavedweller Bracers", "=ds=#s8#, #a3#", "", "34.35%"};
		{ 11, 14151, "", "=q2=Chanting Blade", "=ds=#h1#, #w4#", "", "17.10%"};
		...
		{ 24, 60425, "", "=q2=Bazzalan´s Shroud", "=ds=#s4#", "", ""};
		{ 25, 60429, "", "=q2=Knives of the Satyr", "=ds=#w11#", "", ""};
		{ 26, 60430, "", "=q2=Satyrchain Epaulets", "=ds=#s3#, #a3#", "", ""};
	};
	...
	AtlasLoot_Data["RazorfenDowns1"] = {
		...
		{ 2, 60434, "", "=q3=Cuffs of the Crypt", "=ds=#s8#, #a1#", "", ""};
		...
		{ 13, 60436, "", "=q3=Warmed Boots", "=ds=#s12#", "", ""};
		...
		{ 18, 60435, "", "=q3=Putrid Ring", "=ds=#s13#", "", ""};
		{ 19, 10772, "", "=q2=Glutton's Cleaver", "=ds=#h1#, #w1#", "", "44.22%"};
	...
	AtlasLoot_Data["RazorfenDowns2"] = {
		...
		{ 3, 60431, "", "=q3=Phylactery of Amnennar", "=ds=#s14#", "", ""};
		...
		{ 7, 10765, "", "=q2=Bonefingers", "=ds=#s9#, #a2#"};
		{ 8, 10420, "", "=q1=Skull of the Coldbringer", "=ds=#m3#", "", "100%"};
		{ 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Plaguemaw the Rotting"], ""};
		{ 11, 10766, "", "=q3=Plaguerot Sprig", "=ds=#w12#", "", "29.98%"};
		{ 12, 60432, "", "=q3=Belt of Plaguemaw", "=ds=#s10#", "", ""};
		{ 13, 10760, "", "=q3=Swine Fists", "=ds=#s9#, #a2#", "", "58.15%"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
	...
	AtlasLoot_Data["RazorfenKraul1"] = {
		...
		{ 5, 61971, "", "=q2=Thorn Spiked Mantle", "=ds=#s3#, #a2#", "", ""};
		{ 6, 6681, "", "=q1=Thornspike", "=ds=#h1#, #w4#", "", "57,12%"};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleBoss["Death Speaker Jargba"], ""};
		{ 9, 2816, "", "=q3=Death Speaker Scepter", "=ds=#h3#, #w6#", "", "7.72%"};
		{ 10, 6685, "", "=q2=Death Speaker Mantle", "=ds=#s3#, #a1#", "", "40.42%"};
		{ 11, 6682, "", "=q2=Death Speaker Robes", "=ds=#s5#, #a1#", "", "40.52%"};
		{ 12, 61974, "", "=q2=Death Speaker Cloak", "=ds=#s4#", "", ""};
		{ 14, 0, "INV_Box_01", "=q6="..AL["Razorfen Spearhide"], ""};
		{ 15, 6679, "", "=q2=Armor Piercer", "=ds=#w7#", "", "43%"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Overlord Ramtusk"], ""};
		{ 17, 6687, "", "=q3=Corpsemaker", "=ds=#h2#, #w1#", "", "27.79%"};
		{ 18, 6686, "", "=q2=Tusken Helm", "=ds=#s1#, #a3#", "", "57.14%"};
		{ 20, 0, "INV_Box_01", "=q6="..BabbleBoss["Agathelos the Raging"], ""};
		{ 21, 6691, "", "=q3=Swinetusk Shank", "=ds=#h1#, #w4#", "", "24.85%"};
		{ 22, 6690, "", "=q2=Ferine Leggings", "=ds=#s11#, #a2#", "", "49.21%"};
		{ 23, 61970, "", "=q2=Raging Mask", "=ds=#s1#, #a2#", "", ""};
	...
	AtlasLoot_Data["RazorfenKraul2"] = {
		...
		{ 5, 61973, "", "=q3=Razorfen Trousers", "=ds=#s11#, #a1#", "", ""};
		{ 6, 17008, "", "=q1=Small Scroll", "=ds=#m2# (#m6#)"};
		{ 7, 5793, "", "=q1=Razorflank's Heart", "=ds=#m3#", "", "100%"};
		{ 8, 5792, "", "=q1=Razorflank's Medallion", "=ds=#m3#", "", "100%"};
		{ 10, 0, "INV_Box_01", "=q6="..BabbleBoss["Earthcaller Halmgar"], ""};
		{ 11, 6689, "", "=q3=Wind Spirit Staff", "=ds=#w9#", "", "42.66%"};
		{ 12, 6688, "", "=q3=Whisperwind Headdress", "=ds=#s1#, #a2#", "", "43.75%"};
		{ 16, 0, "INV_Box_01", "=q6="..AL["Trash Mobs"], ""};
		...
		{ 23, 1727, "", "=q3=Sword of Decay", "=ds=#h3#, #w10#", "", "0.02%"};
	...
	AtlasLoot_Data["SMHerod"] = {
		...
		{ 5, 61976, "", "=q3=Berserker´s Cape", "=ds=#s4#", "", ""};
	...
	AtlasLoot_Data["SMCathedral"] = {
		...
		{ 5, 61977, "", "=q2=Mana Twisted Charm", "=ds=#s14#", "", ""};
		...
		{ 12, 61978, "", "=q3=Ring of Hatred", "=ds=#s13#", "", ""};
	...
	AtlasLoot_Data["SMGraveyard"] = {
		...
		{ 2, 7682, "", "=q3=Torturing Poker", "=ds=#h1#, #w4#", "", "5.56%"};
		{ 3, 60437, "", "=q3=Scarlet Bane", "=ds=#h1#, #w4#", "", ""};
		{ 4, 7683, "", "=q2=Bloody Brass Knuckles", "=ds=#h1#, #w13#", "", "66.1%"};
		{ 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Bloodmage Thalnos"], ""};
		{ 7, 7685, "", "=q3=Orb of the Forgotten Seer", "=ds=#s15#", "", "47.07%"};
		{ 8, 60437, "", "=q3=Scarlet Bane", "=ds=#h1#, #w4#", "", ""};
		{ 9, 7684, "", "=q2=Bloodmage Mantle", "=ds=#s3#, #a1#", "", "48.46%"};
	...
	AtlasLoot_Data["SMLibrary"] = {
		...
		{ 2, 61981, "", "=q3=Houndmaster´s Bow", "=ds=#w2#", "", ""};
		...
		{ 17, 7714, "", "=q3=Hypnotic Blade", "=ds=#h1#, #w4#", "", "39.91%"};
		{ 18, 7713, "", "=q3=Illusionary Rod", "=ds=#w9#", "", "38.44%"};
		{ 19, 61980, "", "=q3=Tome of Domination", "=ds=#s15#", "", ""};
		{ 20, 7712, "", "=q3=Mantle of Doan", "=ds=#s3#, #a1#", "", "41.96%"};
		{ 21, 7711, "", "=q3=Robe of Doan", "=ds=#s5#, #a1#", "", "42.86%"};
	...
	AtlasLoot_Data["SMTrash"] = {
		...
		{ 18, 8226, "", "=q3=The Butcher", "=ds=#h3#, #w10#", "", "0.01%"};
	...
	AtlasLoot_Data["VWOWSets33"] = {
		...
		{ 3, 10330, "", "=q3=Scarlet Leggings", "=ds=#s11#, =q2=#n14#", "", "13.2%"};
		{ 4, 10332, "", "=q3=Scarlet Boots", "=ds=#s12#, =q2=#n11#", "", "0.1%"};
		{ 5, 10333, "", "=q2=Scarlet Wristguards", "=ds=#s8#, =q2=#n15#", "", "1.6%"};
		{ 6, 10331, "", "=q2=Scarlet Gauntlets", "=ds=#s9#, =q2=#n13#", "", "1.7%"};
		{ 7, 10329, "", "=q2=Scarlet Belt", "=ds=#s10#, =q2=#n10#", "", "1.6%"};
		Next = "SMTrash";
		Prev = "SMLibrary";
	};
	...
	AtlasLoot_Data["SCHOLOKirtonostheHerald"] = {
		...
		{ 9, 60448, "", "=q3=Gargoyle's Bane", "=ds=#w3#", "", ""};
	...
	AtlasLoot_Data["SCHOLOJandiceBarov"] = {
		...
		{ 9, 60464, "", "=q3=Wildkin Legguards", "=ds=#s11#, #a2#", "", ""};
		{ 11, 13725, "", "=q1=Krastinov's Bag of Horrors", "=ds=#m3#", "", "100%"};
		{ 12, 13523, "", "=q1=Blood of Innocents", "=ds=#m3#", "", "17.8%"};
	...
	AtlasLoot_Data["SCHOLOMarduk"] = {
		...
		{ 2, 14576, "", "=q3=Ebon Hilt of Marduk", "=ds=#h3#, #w10#", "", "6.55%"};
	...
	AtlasLoot_Data["SCHOLOKormok"] = {
		...
		{ 5, 22332, "", "=q3=Blade of Necromancy", "=ds=#h3#, #w10#", "", "25.42%"};
	...
	AtlasLoot_Data["SCHOLOLadyIlluciaBarov"] = {
		{ 1, 60454, "", "=q3=Mam´toth´s Fist", "=ds=#h3#, #w13#", "", ""};
	...
	AtlasLoot_Data["SCHOLOBasement"] = {
		{ 1, 14633, "", "=q3=Necropile Mantle", "=ds=#s3#, #a1#", "", "1.91%"};
		{ 2, 14626, "", "=q3=Necropile Robe", "=ds=#s5#, #a1#", "", "2.37%"};
		{ 3, 14629, "", "=q3=Necropile Cuffs", "=ds=#s8#, #a1#", "", "1.82%"};
		{ 4, 14631, "", "=q3=Necropile Boots", "=ds=#s12#, #a1#", "", "2.42%"};
		{ 5, 14632, "", "=q3=Necropile Leggings", "=ds=#s11#, #a1#", "", "2.16%"};
		{ 6, 14637, "", "=q3=Cadaverous Armor", "=ds=#s5#, #a2#", "", "2.08%"};
		{ 7, 14638, "", "=q3=Cadaverous Leggings", "=ds=#s11#, #a2#", "", "1.93%"};
		{ 8, 14640, "", "=q3=Cadaverous Gloves", "=ds=#s9#, #a2#", "", "1.43%"};
		{ 9, 14636, "", "=q3=Cadaverous Belt", "=ds=#s10#, #a2#", "", "1.82%"};
		{ 10, 14641, "", "=q3=Cadaverous Walkers", "=ds=#s12#, #a2#", "", "1.91%"};
		{ 12, 18681, "", "=q3=Burial Shawl", "=ds=#s3#, #a1#", "", "2.81%"};
		{ 13, 18682, "", "=q3=Ghoul Skin Leggings", "=ds=#s11#, #a2#", "", "3.14%"};
		{ 14, 18684, "", "=q3=Dimly Opalescent Ring", "=ds=#s13#", "", "0.85%"};
		{ 16, 14612, "", "=q3=Bloodmail Legguards", "=ds=#s11#, #a3#", "", "0.87%"};
		{ 17, 14616, "", "=q3=Bloodmail Boots", "=ds=#s12#, #a3#", "", "0.53%"};
		{ 18, 14615, "", "=q3=Bloodmail Gauntlets", "=ds=#s9#, #a3#", "", "0.78%"};
		{ 19, 14614, "", "=q3=Bloodmail Belt", "=ds=#s10#, #a3#", "", "0.42%"};
		{ 20, 14611, "", "=q3=Bloodmail Hauberk", "=ds=#s5#, #a3#", "", "0.79%"};
		{ 21, 14621, "", "=q3=Deathbone Sabatons", "=ds=#s12#, #a4#", "", "1.61%"};
		{ 22, 14620, "", "=q3=Deathbone Girdle", "=ds=#s10#, #a4#", "", "1.32%"};
		{ 23, 14622, "", "=q3=Deathbone Gauntlets", "=ds=#s9#, #a4#", "", "1.52%"};
		{ 24, 14624, "", "=q3=Deathbone Chestplate", "=ds=#s5#, #a4#", "", "1.64%"};
		{ 25, 14623, "", "=q3=Deathbone Legguards", "=ds=#s11#, #a4#", "", "1.75%"};
		{ 27, 18683, "", "=q3=Hammer of the Vesper", "=ds=#h1#, #w6#", "", "2.54%"};
		{ 28, 18680, "", "=q3=Ancient Bone Bow", "=ds=#w2#", "", "3.21%"};
		{ 29, 23201, "", "=q3=Libram of Divinity", "=ds=#s16#, #w16#"};
		{ 30, 23200, "", "=q3=Totem of Sustaining", "=ds=#s16#, #w15#", "", "3.5%"};
	...
	AtlasLoot_Data["SCHOLODarkmasterGandling"] = {
		...
		{ 3, 13944, "", "=q3=Tombstone Breastplate", "=ds=#s5#, #a2#", "", "8.96%"};
		{ 4, 13398, "", "=q3=Boots of the Shrieker", "=ds=#s12#, #a2#", "", "10.75%"};
		{ 5, 60457, "", "=q3=Soul of the Failed Student", "=ds=#s14#", "", ""};
		{ 6, 13950, "", "=q3=Detention Strap", "=ds=#s10#, #a3#", "", "0.24%"};
		{ 7, 13951, "", "=q3=Vigorsteel Vambraces", "=ds=#s8#, #a4#", "", "10.38%"};
		{ 8, 22433, "", "=q3=Don Mauricio's Band of Domination", "=ds=#s13#", "", "7.72%"};
		{ 9, 13964, "", "=q3=Witchblade", "=ds=#h1#, #w4#", "", "9.82%"};
		{ 10, 13953, "", "=q3=Silent Fang", "=ds=#h3#, #w10#", "", "9.68%"};
		{ 11, 13938, "", "=q3=Bonecreeper Stylus", "=ds=#w12#", "", "8.80% "};
		{ 12, 60450, "", "=q3=Headmaster's Mantle", "=ds=#s4#", "", ""};
		{ 14, 19276, "", "=q3=Ace of Portals", "=ds=#e16#", "", "2.20%"};
		...
		{ 26, 13501, "", "=q2=Recipe: Major Mana Potion", "=ds=#p1# (295)", "", "8.64%"};
		{ 28, 14514, "", "=q4=Pattern: Robe of the Void", "=ds=#p8# (300) =q1=#m1# =ds=#c8#", "", "6.71%"};
		{ 29, 14153, "", "=q4=Robe of the Void", "=ds=#s5#, #a1# =q1=#m1# =ds=#c8#"};
		Next = "SCHOLOTrash";
		Prev = "SCHOLOBasement";
	};
	...
	AtlasLoot_Data["ShadowfangKeep1"] = {
		...
		{ 5, 6341, "", "=q2=Eerie Stable Lantern", "=ds=#s15#", "", "5.48%"};
		{ 6, 932, "", "=q2=Fel Steed Saddlebags", "=ds=#m12# #e1#", "", "16.46%"};
		{ 8, 0, "INV_Box_01", "=q6="..BabbleEpoch["Steward Graves"], ""};
		{ 9, 60470, "", "=q3=Graves Rod", "=ds=#w12#", "", ""};
		{ 10, 60469, "", "=q3=Belt of Service", "=ds=#s10#, #a2#", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Razorclaw the Butcher"], ""};
		{ 17, 1292, "", "=q3=Butcher's Cleaver", "=ds=#h1#, #w1#", "", "8.70%"};
		{ 18, 6226, "", "=q2=Bloody Apron", "=ds=#s5#, #a1#", "", "39.47%"};
		{ 19, 6633, "", "=q2=Butcher's Slicer", "=ds=#h1#, #w10#", "", "39.53%"};
		{ 21, 0, "INV_Box_01", "=q6="..BabbleBoss["Baron Silverlaine"], ""};
		{ 22, 6321, "", "=q3=Silverlaine's Family Seal", "=ds=#s13#", "", "18.91%"};
		{ 23, 6323, "", "=q2=Baron's Scepter", "=ds=#h1#, #w6#", "", "37.93%"};
		{ 25, 0, "INV_Box_01", "=q6="..BabbleBoss["Commander Springvale"], ""};
		{ 26, 6320, "", "=q3=Commander's Crest", "=ds=#w8#", "", "27.71%"};
		{ 27, 3191, "", "=q2=Arced War Axe", "=ds=#h2#, #w1#", "", "31.73%"};
	...
	AtlasLoot_Data["ShadowfangKeep2"] = {
		...
		{ 3, 6319, "", "=q2=Girdle of the Blindwatcher", "=ds=#s10#, #a2#", "", "57.15%"};
		{ 5, 0, "INV_Box_01", "=q6="..BabbleBoss["Deathsworn Captain"], ""};
		{ 6, 6642, "", "=q3=Phantom Armor", "=ds=#s5#, #a3#", "", "30.49%"};
		{ 7, 6641, "", "=q2=Haunting Blade", "=ds=#h2#, #w10#", "", "58.60%"};
		{ 9, 0, "INV_Box_01", "=q6="..BabbleBoss["Fenrus the Devourer"], ""};
		{ 10, 60471, "", "=q3=Helm of the Devourer", "=ds=#s1#, #a2#", "", ""};
		{ 11, 6340, "", "=q2=Fenrus' Hide", "=ds=#s4#", "", "58.02%"};
		{ 12, 3230, "", "=q2=Black Wolf Bracers", "=ds=#s8#, #a2#", "", "14.76%"};
		...
		{ 17, 3748, "", "=q3=Feline Mantle", "=ds=#s3#, #a1#", "", "48.55%"};
		{ 18, 6314, "", "=q2=Wolfmaster Cape", "=ds=#s4#", "", "33.25%"};
		...
		{ 24, 60472, "", "=q3=Orb of Arugal", "=ds=#s14#", "", ""};
	...
	AtlasLoot_Data["ShadowfangKeep3"] = {
		...
		{ 6, 1482, "", "=q3=Shadowfang", "=ds=#h3#, #w10#", "", "0.01%"};
	...
	AtlasLoot_Data["STRATSkull"] = {
		...
		{ 4, 60493, "", "=q3=Festival's Feathery Crown", "=ds=#s1#, #a3#", "", ""};
		{ 5, 60507, "", "=q3=Scourge-Touched Strand", "=ds=#s2#", "", ""};
	...
	AtlasLoot_Data["STRATFrasSiabi"] = {
		{ 1, 60498, "", "=q3=Gittelle", "=ds=#h1#, #w4#", "", ""};
		{ 2, 60497, "", "=q2=Gauntlets of Restoration", "=ds=#s9#, #a3#", "", ""};
		{ 4, 13172, "", "=q1=Siabi's Premium Tobacco", "=ds=#m3#", "", "100%"};
		{ 5, 13171, "", "=q2=Smokey's Lighter", "=q1=#m4#: =ds=#s14#"};
	...
	AtlasLoot_Data["STRATHearthsingerForresten"] = {
		...
		{ 5, 60508, "", "=q3=Stone-Worked Gauntlets", "=ds=#s9#, #a4#", "", ""};
		{ 16, 16682, "", "=q3=Magister's Boots", "=ds=#s12#, #a1# (D1, #c3#)", "", "10.86%"};
		{ 18, 64936, "", "=q1=Recipe: Stratholme Saperavi", "=ds=#p3# (300)", "", ""};
	...
	AtlasLoot_Data["STRATTimmytheCruel"] = {
		...
		{ 5, 60511, "", "=q3=Timmy´s Riding Gloves", "=ds=#s9#, #a2#", "", ""};
		{ 6, 60490, "", "=q3=Crusader's Espalier", "=ds=#s3#, #a3#", "", ""};
	...
	AtlasLoot_Data["STRATCannonMasterWilley"] = {
		...
		{ 10, 60484, "", "=q3=Ardent Shoulderguards", "=ds=#s3#, #a4#", "", ""};
		{ 12, 13377, "", "=q3=Miniature Cannon Balls", "=ds=#w18#", "", "66.61%"};
	...
	AtlasLoot_Data["STRATArchivistGalford"] = {
		...
		{ 5, 60485, "", "=q3=Blessed-Thread Gloves", "=ds=#s9#, #a1#", "", ""};
		{ 6, 22897, "", "=q3=Tome of Conjure Food VII", "=ds=#e10# =q1=#m1# =ds=#c3#", "", "4.86%"};
		{ 8, 12811, "", "=q2=Righteous Orb", "=ds=#e8#", "", "61.3%"};
		{ 10, 0, "INV_Box_01", "=q6=#x11#", ""};
		{ 11, 14679, "", "=q1=Of Love and Family", "=ds=#m3#"};
	...
	AtlasLoot_Data["STRATBalnazzar"] = {
		...
		{ 14, 60499, "", "=q3=Grand Crusader´s Cuirass", "=ds=#s5#, #a4#", "", ""};
		{ 15, 60492, "", "=q3=Fel-Corrupted Holy Water", "=ds=#s14#", "", ""};
	...
	AtlasLoot_Data["STRATBaronessAnastari"] = {
		...
		{ 4, 60491, "", "=q3=Fallen Crusader's Girdle", "=ds=#s10#, #a4#", "", ""};		
		{ 5, 18729, "", "=q3=Screeching Bow", "=ds=#w2#", "", "15.59%"};
	...
	AtlasLoot_Data["STRATNerubenkan"] = {
		...
		{ 5, 60505, "", "=q3=Rover´s Shoulders", "=ds=#s3#, #a2#", "", ""};
		{ 6, 60482, "", "=q3=Ancient Nerubian Torc", "=ds=#s2#", "", ""};
		{ 8, 13530, "", "=q2=Fangdrip Runners", "=ds=#s12#, #a1#", "", "8.49%"};
		{ 9, 13531, "", "=q2=Crypt Stalker Leggings", "=ds=#s11#, #a2#", "", "10.17%"};
		{ 10, 13532, "", "=q2=Darkspinner Claws", "=ds=#s9#, #a3#", "", "9.69%"};
		{ 11, 13533, "", "=q2=Acid-etched Pauldrons", "=ds=#s3#, #a4#", "", "8.11%"};
		{ 12, 13508, "", "=q2=Eye of Arachnida", "=ds=#m8#", "", "7.39%"};
	...
	AtlasLoot_Data["STRATMalekithePallid"] = {
		...
		{ 5, 60510, "", "=q3=Thuzadin Tiara", "=ds=#s1#, #a3#", "", ""};
		{ 6, 60489, "", "=q3=Cloak of Renewal", "=ds=#s4#", "", ""};
	...
	AtlasLoot_Data["STRATMagistrateBarthilas"] = {
		...
		{ 7, 60501, "", "=q3=Magistrate´s Scepter", "=ds=#s15#", "", ""};
		{ 8, 60488, "", "=q3=Breeches of Bruised Flesh", "=ds=#s11#, #a1#", "", ""};
		{ 10, 12382, "", "=q2=Key to the City", "=ds=#e9#", "", "100%"};
	...
	AtlasLoot_Data["STRATRamsteintheGorger"] = {
		...
		{ 7, 60503, "", "=q3=Pauldrons of the Fallen Champion", "=ds=#s3#, #a3#", "", ""};
		{ 8, 60486, "", "=q3=Blightcaller´s Bane", "=ds=#w5#", "", ""};
	...
	AtlasLoot_Data["STRATBaronRivendare"] = {
		...
		{ 14, 13349, "", "=q3=Scepter of the Unholy", "=ds=#h3#, #w6#", "", "9.30%"};
		...
		{ 25, 60514, "", "=q3=Zeliek´s Trews", "=ds=#s11#, #a4#", "", ""};
		{ 27, 13251, "", "=q1=Head of Baron Rivendare", "=ds=#m3#", "", "100%"};
		{ 28, 13246, "", "=q3=Argent Avenger", "=q1=#m4#: =ds=#h1#, #w10#"};
		{ 29, 13249, "", "=q3=Argent Crusader", "=q1=#m4#: =ds=#w9#"};
		{ 30, 13243, "", "=q3=Argent Defender", "=q1=#m4#: =ds=#w8#"};
		Next = "STRATTrash";
	...
	AtlasLoot_Data["TheDeadmines2"] = {
		...
		{ 2, 5192, "", "=q2=Thief's Blade", "=ds=#h1#, #w10#", "", "34.96%"};
		{ 3, 5196, "", "=q2=Smite's Reaver", "=ds=#h1#, #w1#", "", "33.95%"};
		...
		{ 11, 61913, "", "=q1=Eternal Ember", "=ds=#m2# (Alliance)", "", ""};
		{ 16, 0, "INV_Box_01", "=q6=#n7#", ""};
		{ 17, 10403, "", "=q2=Blackened Defias Belt", "=ds=#s10#, #a2#", "", "23.26%"};
		{ 18, 5200, "", "=q2=Impaling Harpoon", "=ds=#w7#", "", "25.39%"};
		...
		{ 24, 7997, "", "=q3=Red Defias Mask", "=ds=#s1#, #a2#", "", ""};
	...
	AtlasLoot_Data["TheDeadmines3"] = {
		...
		{ 2, 5197, "", "=q2=Cookie's Tenderizer", "=ds=#h1#, #w6#", "", "49.62%"};
	...
	AtlasLoot_Data["VWOWSets11"] = {
		...
		{ 2, 7997, "", "=q3=Red Defias Mask", "=ds=#s1#, =q2=#n6#", "", ""};
	...
	AtlasLoot_Data["TheStockade"] = {
		...
		{ 7, 2280, "", "=q2=Kam's Walking Stick", "=ds=#w9#", "", "0.62%"};
		{ 8, 60479, "", "=q2=Spellbuckler", "=ds=#w8#", "", ""};
		{ 9, 3640, "", "=q1=Head of Deepfury", "=ds=#m3#", "", "100%"};
		{ 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Hamhock"], ""};
		{ 12, 60477, "", "=q3=Hamhock´s Cleaver", "=ds=#h1#, #w1#", "", ""};
		{ 13, 60480, "", "=q2=Wand of Ogrehair", "=ds=#w12#", "", ""};
	...
	AtlasLoot_Data["STSpawnOfHakkar"] = {
		{ 1, 10801, "", "=q3=Slitherscale Boots", "=ds=#s12#, #a2#", "", "42.33%"};
		{ 2, 10802, "", "=q2=Wingveil Cloak", "=ds=#s4#", "", "25.6%"};
		Next = "STTrollMinibosses";
	};
	...
	AtlasLoot_Data["STTrollMinibosses"] = {
		...
		{ 3, 10784, "", "=q3=Atal'ai Breastplate", "=ds=#s5#, #a3# =q2=#m16#", "", "2.12%"};
		{ 4, 10785, "", "=q2=Atal'ai Leggings", "=ds=#s11#, #a2# =q2=#m16#", "", "4.42%"};
	...
	AtlasLoot_Data["STAvatarofHakkar"] = {
		...
		{ 7, 10838, "", "=q3=Might of Hakkar", "=ds=#h3#, #w6#", "", "16.37%"};
	...
	AtlasLoot_Data["STOgom"] = {
		{ 1, 10805, "", "=q2=Eater of the Dead", "=ds=#h1#, #w1#", "", "28.27%"};
		{ 2, 10804, "", "=q2=Fist of the Damned", "=ds=#h1#, #w6#", "", "30.03%"};
		{ 3, 10803, "", "=q2=Blade of the Wretched", "=ds=#h3#, #w10#", "", "28.21%"};
		Next = "STMorphaz";
		Prev = "STJammalan";
	};
	...
	AtlasLoot_Data["UldRevelosh"] = {
		{ 1, 9390, "", "=q2=Revelosh's Gloves", "=ds=#s9#, #a1# =q2=#m16#", "", "20.08%"};
		{ 2, 9389, "", "=q2=Revelosh's Spaulders", "=ds=#s3#, #a2# =q2=#m16#", "", "18.77%"};
		{ 3, 9388, "", "=q2=Revelosh's Armguards", "=ds=#s8#, #a3# =q2=#m16#", "", "19.84%"};
		{ 4, 9387, "", "=q2=Revelosh's Boots", "=ds=#s12#, #a4# =q2=#m16#", "", "20.53%"};
	...
	AtlasLoot_Data["UldIronaya"] = {
		...
		{ 4, 60672, "", "=q3=Marred Uldic Hands", "=ds=#s9#, #a3#", "", ""};
		Next = "UldObsidianSentinel";
		Prev = "UldRevelosh";
	};

	AtlasLoot_Data["UldObsidianSentinel"] = {
		{ 1, 60673, "", "=q2=Marred Uldic Helm", "=ds=#s1#, #a4#", "", ""};
		{ 3, 8053, "", "=q1=Obsidian Power Source", "=ds=#m3#", "", "100%"};
		Next = "UldAncientStoneKeeper";
		Prev = "UldIronaya";
	};

	AtlasLoot_Data["UldAncientStoneKeeper"] = {
		{ 1, 9410, "", "=q3=Cragfists", "=ds=#s9#, #a4# =q2=#m16#", "", "41.61%"};
		{ 2, 60677, "", "=q3=Regenerative Stone Belt", "=ds=#s10#, #a4#", "", ""};
		{ 3, 9411, "", "=q2=Rockshard Pauldrons", "=ds=#s3#, #a3#", "", "43.41%"};
		Next = "UldGalgannFirehammer";
		Prev = "UldObsidianSentinel";
	};

	AtlasLoot_Data["UldGalgannFirehammer"] = {
		{ 1, 9412, "", "=q3=Galgann's Fireblaster", "=ds=#w5#", "", "17.10%"};
		{ 2, 11310, "", "=q3=Flameseer Mantle", "=ds=#s3#, #a1#", "", "17.35%"};
		{ 3, 9419, "", "=q2=Galgann's Firehammer", "=ds=#h1#, #w6#", "", "18.10%"};
		{ 4, 11311, "", "=q2=Emberscale Cape", "=ds=#s4#", "", "36.52%"};
		Next = "UldGrimlok";
	...
	AtlasLoot_Data["UldArchaedas"] = {
		{ 1, 60671, "", "=q3=Marred Uldic Chestplate", "=ds=#s5#, #a4#", "", ""};
		...
		{ 5, 60678, "", "=q3=Tablet of Ancient Wisdom", "=ds=#s14#", "", ""};
	...
	AtlasLoot_Data["UldTrash"] = {
		...
		{ 14, 60675, "", "=q3=Marred Uldic Sabatons", "=ds=#s12#, #a4#", ""};
		{ 15, 60676, "", "=q2=Marred Uldic Shoulderpads", "=ds=#s3#, #a4#", ""};
	...
	AtlasLoot_Data["WailingCavernsEnt"] = {	
		...
		{ 5, 5426, "", "=q3=Serpent's Kiss", "=ds=#h1#, #w1#", "", "35%"};
		{ 6, 5425, "", "=q2=Runescale Girdle", "=ds=#s8#, #a3#", "", "50%"};
	...
	AtlasLoot_Data["WailingCaverns1"] = {	
		...
		{ 2, 5404, "", "=q2=Serpent's Shoulders", "=ds=#s3#, #a2#", "", "58.61%"};
		{ 3, 10412, "", "=q2=Belt of the Fang", "=ds=#s10#, #a2#", "", "8.63%"};
		{ 4, 6446, "", "=q1=Snakeskin Bag", "=ds=#m12# #e1#", "", "6.61%"};
		{ 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Skum"], ""};
		{ 7, 6449, "", "=q3=Glowing Lizardscale Cloak", "=ds=#s4#", "", "38.24%"};
		{ 8, 6448, "", "=q2=Tail Spike", "=ds=#h1#, #w4#", "", "39.24%"};
		{ 11, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Pythas"], ""};
		{ 12, 6472, "", "=q3=Stinging Viper", "=ds=#h1#, #w6#", "", "28.24%"};
		{ 13, 6473, "", "=q2=Armor of the Fang", "=ds=#s5#, #a2#", "", "52.06%"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Verdan the Everliving"], ""};
		{ 17, 6631, "", "=q3=Living Root", "=ds=#w9#", "", "34.47%"};
		{ 18, 6630, "", "=q3=Seedcloud Buckler", "=ds=#w8#", "", "35.38%"};
		{ 19, 6629, "", "=q2=Sporid Cape", "=ds=#s4#", "", "16.65%"};
		{ 21, 0, "INV_Box_01", "=q6="..BabbleEpoch["Razor"], ""};
		{ 22, 62050, "", "=q2=Raptor Claws", "=ds=#s1#, #w13#", "", ""};
		{ 23, 62051, "", "=q2=Raptor Spaulders", "=ds=#s3#, #a3#", "", ""};
		{ 24, 48114, "", "=q1=Deviate Hatchling", "=ds=#e13#", "", ""};
		{ 26, 0, "INV_Box_01", "=q6="..BabbleBoss["Kresh"], ""};
		{ 27, 13245, "", "=q3=Kresh's Back", "=ds=#w8#", "", "9.17%"};
		{ 28, 6447, "", "=q2=Worn Turtle Shell Shield", "=ds=#w8#", "", "63.66%"};
	...
	AtlasLoot_Data["WailingCaverns2"] = {
		...
		{ 3, 62049, "", "=q3=Emerald Amulet", "=ds=#s2#", "", ""};
		{ 4, 6632, "", "=q2=Feyscale Cloak", "=ds=#s4#", "", "37.84%"};
		{ 6, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Serpentis"], ""};
		{ 7, 6469, "", "=q3=Venomstrike", "=ds=#w2#", "", "16.63%"};
		{ 8, 5970, "", "=q2=Serpent Gloves", "=ds=#s9#, #a1#", "", "20.96%"};
		{ 9, 10411, "", "=q2=Footpads of the Fang", "=ds=#s12#, #a2#", "", "19.07%"};
		{ 10, 6459, "", "=q2=Savage Trodders", "=ds=#s12#, #a3#", "", "24.39%"};
		{ 12, 0, "INV_Box_01", "=q6="..BabbleBoss["Lord Cobrahn"], ""};
		{ 13, 10410, "", "=q3=Leggings of the Fang", "=ds=#s11#, #a2#", "", "16.03%"};
		{ 14, 6460, "", "=q3=Cobrahn's Grasp", "=ds=#s10#, #a3#", "", "16.20%"};
		{ 15, 6465, "", "=q2=Robe of the Moccasin", "=ds=#s5#, #a1#", "", "51.73%"};
	...
	AtlasLoot_Data["VWOWSets22"] = {
		...
		{ 2, 6473, "", "=q2=Armor of the Fang", "=ds=#s5#, =q2=#n5#", "", "52.05%"};
		{ 3, 10413, "", "=q2=Gloves of the Fang", "=ds=#s9#, =q2=#n4#", "", "1.20%"};
		{ 4, 10412, "", "=q2=Belt of the Fang", "=ds=#s10#, =q2=#n2#", "", "8.64%"};
		{ 5, 10410, "", "=q3=Leggings of the Fang", "=ds=#s11#, =q2=#n1#", "", "16.03%"};
		{ 6, 10411, "", "=q2=Footpads of the Fang", "=ds=#s12#, =q2=#n3#", "", "19.08%"};
	...
	AtlasLoot_Data["ZFThekatheMartyr"] = {
		{ 1, 62058, "", "=q3=Scarred Leggings", "=ds=#s11#", "", ""};
		{ 2, 62059, "", "=q3=Theka´s Seal of Vigilance", "=ds=#s13#", "", ""};
		{ 4, 10660, "", "=q1=First Mosh'aru Tablet", "=ds=#m3#", "", "100%"};
	...
	AtlasLoot_Data["ZFSergeantBly"] = {
		{ 1, 62055, "", "=q3=Bly´s Shield", "=ds=#w8#", "", ""};
		{ 2, 62056, "", "=q3=Shadow Trousers", "=ds=#s11#, #a1#", "", ""};
		{ 3, 62057, "", "=q3=Rough Grips", "=ds=#s9#", "", ""};
	...
	AtlasLoot_Data["ZFHydromancerVelratha"] = {
		{ 1, 62054, "", "=q3=Hydromancer´s Crystal", "=ds=#s15#", "", ""};
		{ 2, 62053, "", "=q3=Sandfury Slippers", "=ds=#s12#, #a2#", "", ""};
		{ 3, 62052, "", "=q3=Sacred Helm", "=ds=#s1#, #a3#", "", ""};
		{ 5, 9234, "", "=q1=Tiara of the Deep", "=ds=#m3#", "", "100%"};
	...
	AtlasLoot_Data["ZFGahzrilla"] = {
		...
		{ 2, 9467, "", "=q2=Gahz'rilla Fang", "=ds=#h1#, #w4#", "", "36.83%"};
	...
	AtlasLoot_Data["VWOWWeapons"] = {
		...
		{ 10, 60679, "", "=q3=Abominable Claw of Striking", ""};
		{ 11, 60680, "", "=q3=Abominable Claw of Gashing", ""};
		{ 24, 0, "INV_Box_01", "=q6="..BabbleEpoch["Devilsaur Claws"], ""};
		{ 25, 20003, "", "=q3=Devilsaur´s Right Claws", ""};
		{ 26, 20005, "", "=q3=Devilsaur´s Left Claws", ""};
		Prev = "Epochset0";
		Back = "SETSCLASSIC";
	};
	...
	AtlasLoot_Data["Smokywood"] = {
		{ 1, 0, "inv_misc_note_05", "=q6=#r5#", ""};
		{ 3, 37719, "", "=q4=Swift Zhevra", ""};
		{ 4, 62993, "", "=q4=Baby Giraffe", ""};
		{ 5, 62995, "", "=q4=Recipe: Deviate Feast", ""};
		Back = "REPMENU";
	};
	...
	AtlasLoot_Data["Valorsexp"] = {
		...
		{ 17, 60645, "", "=q3=Recipe: Elixir of Whirling Wind", ""};
		{ 18, 60651, "", "=q3=Pattern: Shoulderpads of Dazzling Light", ""};
		...
		{ 23, 60644, "", "=q3=Breastplate of the Chosen", ""};
	...
	AtlasLoot_Data["Valorsexp2"] = {
		...
		{ 2, 60657, "", "=q3=Recipe: Elixir of Valorous Diplomacy", ""};
		{ 3, 60660, "", "=q3=Pattern: Leggings of Dazzling Light", ""};
		{ 4, 60653, "", "=q3=Crescent of the Brood", ""};
		{ 5, 60654, "", "=q3=Crystal Adder´s Tongue", ""};
		{ 6, 60655, "", "=q3=Cultist´s Throwing Axe", ""};
		{ 7, 60656, "", "=q3=Dark Desert Roses", ""};
		{ 8, 60658, "", "=q3=Kaldorei Guard", ""};
		{ 9, 60661, "", "=q3=Painted Spirit Shield", ""};
		{ 16, 0, "achievement_zone_silithus_01", "=q6=#r5#", ""};
		{ 17, 60666, "", "=q3=Pattern: Robe of Dazzling Light", ""};
		{ 18, 60662, "", "=q3=Deep Rooted Ring", ""};
		{ 19, 60663, "", "=q3=Efflorescent Alpenstock", ""};
		{ 20, 60664, "", "=q3=Engergy-Twisted Halberd", ""};
	...
	AtlasLoot_Data["Tabards1"] = {
		{ 1, 49052, "", "=q3=Tabard of Savagery", "=ds=#s7#", "1 #epvpw#", ""};
		{ 2, 60774, "", "=q=Scholomance Tabard", "=ds=#s7#", "", ""};
	...
	AtlasLoot_Data["PetsShop"] = {
		{ 1, 110012, "", "=q7=Nightsaber Cub", "", "", ""};
		{ 2, 32588, "", "=q7=Banana Charm", "", "", ""};
		{ 3, 64951, "", "=q7=Bronze Whelpling", "", "", ""};
		Prev = "PetsAchievent1";
		Back = "PETMENU";
	};
	...
	AtlasLoot_Data["ToysShop"] = {
		{ 1, 34499, "", "=q7=Paper Flying Machine Kit", "", "", ""};
		{ 2, 32566, "", "=q7=Picnic Basket", "", "", ""};
		{ 3, 33223, "", "=q7=Fishing Chair", "", "", ""};
		{ 4, 33219, "", "=q7=Goblin Gumbo Kettle", "", "", ""};
		Back = "TOYMENU";
	};
	...
	AtlasLoot_Data["ShopCosmetics"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Shirts"], ""};
		{ 2, 41249, "", "=q7=Blue Lumberjack Shirt", "", "", ""};
		{ 3, 41248, "", "=q7=Red Lumberjack Shirt", "", "", ""};
		{ 4, 41250, "", "=q7=Green Lumberjack Shirt", "", "", ""};
		{ 5, 41251, "", "=q7=Yellow Lumberjack Shirt", "", "", ""};
		{ 7, 0, "INV_Box_01", "=q6="..BabbleEpoch["Shipwrecked Attire"], ""};
		{ 8, 110010, "", "=q7=Shipwrecked Chest", "", "", ""};
		{ 9, 110008, "", "=q7=Shipwrecked Gloves", "", "", ""};
		{ 10, 110011, "", "=q7=Shipwrecked Legs", "", "", ""};
		{ 11, 110009, "", "=q7=Shipwrecked Feet", "", "", ""};
		{ 13, 0, "INV_Box_01", "=q6="..BabbleEpoch["Savage Blood Troll Wraps"], ""};
		{ 14, 110002, "", "=q7=Savage Blood Troll Chest Wraps", "", "", ""};
		{ 15, 110003, "", "=q7=Savage Blood Troll Leg Wraps", "", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Head Pieces"], ""};
		{ 17, 110014, "", "=q7=Gaze of Infernal Control", ""};
		{ 18, 110013, "", "=q7=Gaze of Radient Control", ""};
		{ 19, 110015, "", "=q7=Gaze of Relentless Control", ""};
		{ 20, 110016, "", "=q7=Gaze of Incy Control", ""};
		{ 21, 110017, "", "=q7=Gaze of Fiery Control", ""};
		{ 22, 110018, "", "=q7=Gaze of Primal Control", ""};
		{ 23, 110019, "", "=q7=Gaze of Mystic Control", ""};
		{ 24, 110045, "", "=q7=Huntsman´s Arrow", ""};
		{ 25, 110046, "", "=q7=Marksman´s Arrow", ""};
		{ 26, 110047, "", "=q7=Ranger´s Arrow", ""};
		{ 28, 0, "INV_Box_01", "=q6="..BabbleEpoch["Berserker's Pale Tattoos"], ""};
		{ 29, 110006, "", "=q7=Berserker's Pale Chest Tattoos", "", "", ""};
		{ 30, 110007, "", "=q7=Berserker's Pale Leg Tattoos", "", "", ""};
		Next = "ShopCosmetics1";
		Back = "SETMENU";
	};

	AtlasLoot_Data["ShopCosmetics1"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Arcane Acolyte's Garments"], ""};
		{ 2, 110020, "", "=q7=Arcane Acolyte's Collar", ""};
		{ 3, 110021, "", "=q7=Arcane Acolyte's Tunic", ""};
		{ 4, 110022, "", "=q7=Arcane Acolyte's Robe", ""};
		{ 5, 110025, "", "=q7=Arcane Acolyte's Gloves", ""};
		{ 6, 110024, "", "=q7=Arcane Acolyte's Sash", ""};
		{ 7, 110023, "", "=q7=Arcane Acolyte's Skirt", ""};
		{ 8, 110026, "", "=q7=Arcane Acolyte's Shoes", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Light's Chosen Garments"], ""};
		{ 17, 110031, "", "=q7=Light's Chosen Collar", ""};
		{ 18, 110032, "", "=q7=Light's Chosen Tunic", ""};
		{ 19, 110033, "", "=q7=Light's Chosen Robe", ""};
		{ 20, 110036, "", "=q7=Light's Chosen Bracers", ""};
		{ 21, 110035, "", "=q7=Light's Chosen Sash", ""};
		{ 22, 110034, "", "=q7=Light's Chosen Skirt", ""};
		{ 23, 110037, "", "=q7=Light's Chosen Shoes", ""};
		Next = "ShopCosmetics2";
		Prev = "ShopCosmetics";
		Back = "SETMENU";
	};

	AtlasLoot_Data["ShopCosmetics2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Dalaran Conjuror's Garments"], ""};
		{ 2, 110057, "", "=q7=Dalaran Conjuror's Pauldrons", ""};
		{ 3, 110052, "", "=q7=Dalaran Conjuror's Tunic", ""};
		{ 4, 110053, "", "=q7=Dalaran Conjuror's Robe", ""};
		{ 5, 110055, "", "=q7=Dalaran Conjuror's Bracers", ""};
		{ 6, 110058, "", "=q7=Dalaran Conjuror's Sash", ""};
		{ 7, 110054, "", "=q7=Dalaran Conjuror's Skirt", ""};
		{ 8, 110056, "", "=q7=Dalaran Conjuror's Shoes", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Dalaran Mages's Garments"], ""};
		{ 17, 110050, "", "=q7=Dalaran Mages's Pauldrons", ""};
		{ 18, 110059, "", "=q7=Dalaran Mages's Tunic", ""};
		{ 19, 110060, "", "=q7=Dalaran Mages's Robe", ""};
		{ 20, 110048, "", "=q7=Dalaran Mages's Bracers", ""};
		{ 21, 110051, "", "=q7=Dalaran Mages's Sash", ""};
		{ 22, 110061, "", "=q7=Dalaran Mages's Skirt", ""};
		{ 23, 110049, "", "=q7=Dalaran Mages's Shoes", ""};
		Next = "ShopCosmetics3";
		Prev = "ShopCosmetics1";
		Back = "SETMENU";
	};

	AtlasLoot_Data["ShopCosmetics3"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Dark Caster's Garments"], ""};
		{ 2, 110038, "", "=q7=Dark Caster's Collar", ""};
		{ 3, 110039, "", "=q7=Dark Caster's Tunic", ""};
		{ 4, 110083, "", "=q7=Dark Caster's Covering", ""};
		{ 5, 110040, "", "=q7=Dark Caster's Robe", ""};
		{ 6, 110043, "", "=q7=Dark Caster's Gloves", ""};
		{ 7, 110042, "", "=q7=Dark Caster's Sash", ""};
		{ 8, 110041, "", "=q7=Dark Caster's Skirt", ""};
		{ 9, 110044, "", "=q7=Dark Caster's Shoes", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Stout Warrior's Ensemble"], ""};
		{ 17, 110062, "", "=q7=Stout Warrior's Tunic", ""};
		{ 18, 110063, "", "=q7=Stout Warrior's Garment", ""};
		{ 19, 110065, "", "=q7=Stout Warrior's Bracers", ""};
		{ 20, 110067, "", "=q7=Stout Warrior's Belt", ""};
		{ 21, 110064, "", "=q7=Stout Warrior's Skirt", ""};
		{ 22, 110066, "", "=q7=Stout Warrior's Boots", ""};
		Next = "ShopCosmetics4";
		Prev = "ShopCosmetics2";
		Back = "SETMENU";
	};

	AtlasLoot_Data["ShopCosmetics4"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleEpoch["Noble Warrior's Ensemble"], ""};
		{ 2, 110070, "", "=q7=Noble Warrior's Pauldrons", ""};
		{ 3, 110069, "", "=q7=Noble Warrior's Tunic", ""};
		{ 4, 110072, "", "=q7=Noble Warrior's Bracers", ""};
		{ 5, 110075, "", "=q7=Noble Warrior's Gloves", ""};
		{ 6, 110074, "", "=q7=Noble Warrior's Belt", ""};
		{ 7, 110071, "", "=q7=Noble Warrior's Breeches", ""};
		{ 8, 110073, "", "=q7=Noble Warrior's Boots", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleEpoch["Loyal Warrior's Ensemble"], ""};
		{ 17, 110077, "", "=q7=Loyal Warrior's Pauldrons", ""};
		{ 18, 110076, "", "=q7=Loyal Warrior's Tunic", ""};
		{ 19, 110079, "", "=q7=Loyal Warrior's Bracers", ""};
		{ 20, 110082, "", "=q7=Loyal Warrior's Gloves", ""};
		{ 21, 110081, "", "=q7=Loyal Warrior's Belt", ""};
		{ 22, 110078, "", "=q7=Loyal Warrior's Breeches", ""};
		{ 23, 110080, "", "=q7=Loyal Warrior's Boots", ""};
		Prev = "ShopCosmetics3";
		Back = "SETMENU";
	};
	...
	AtlasLoot_Data["EpochChallenges"] = {
		{ 1, 0, "achievement_level_20", "=q6="..BabbleEpoch["Level 20"], ""};
		{ 2, 62082, "", "=q1=Potion of Plaguewood", "", "", ""};
		{ 3, 23871, "", "=q1=Potion of Water Breathing", "", "", ""};
		{ 4, 9318, "", "=q1=Red Firework5", "=q2=x5", "", ""};
		{ 5, 9313, "", "=q1=Green Firework5", "=q2=x5", "", ""};
		{ 6, 5634, "", "=q1=Free Action Potion", "", "", ""};
		{ 7, 3388, "", "=q1=Strong Troll´s Blood Elixir", "=q2=x3", "", ""};
		{ 8, 2459, "", "=q1=Swiftness Potion", "=q2=x2", "", ""};
		{ 9, 63843, "", "=q2=Chronicler Bindle", "=q6=Soul of Iron only", "", ""};
		{ 10, 63837, "", "=q2=Steamwheedle Bindle", "=q6=Explorers Contract only", "", ""};
		{ 16, 0, "achievement_level_40", "=q6="..BabbleEpoch["Level 40"], ""};
		{ 17, 18294, "", "=q1=Elixir of Greater Water Breathing", "", "", ""};
		{ 18, 12190, "", "=q1=Dreamless Sleep Potion", "=q2=x5", "", ""};
		{ 19, 9315, "", "=q1=Yellow Rose Firework", "=q2=x5", "", ""};
		{ 20, 9172, "", "=q1=Invisibility Potion", "", "", ""};
		{ 21, 5740, "", "=q1=Red Fireworks Rocket", "=q2=x5", "", ""};
		{ 22, 2459, "", "=q1=Swiftness Potion", "=q2=x5", "", ""};
		{ 23, 2091, "", "=q1=Magic Dust", "=q2=x2", "", ""};
		{ 24, 63845, "", "=q2=Chronicler Pouch", "=q6=Soul of Iron only", "", ""};
		{ 25, 63839, "", "=q2=Steamwheedle Pouch", "=q6=Explorers Contract only", "", ""};
		{ 12, 0, "achievement_level_60", "=q6="..BabbleEpoch["Level 60"], ""};
		Back = "SETMENU";
	};
	...
	AtlasLoot_Data["MountsShop"] = {
		{ 1, 0, "inv_misc_coin_01", "=q6="..BabbleEpoch["Shop Mounts"], ""};
		{ 2, 110001, "", "=q7=Savage Raptor", "=ds=#e12# =ec1=#m7#"};
		{ 3, 110000, "", "=q7=Swift Shorestrider´s Reins", "=ds=#e12# =ec1=#m7#"};
		Back = "MOUNTMENU";
	};
